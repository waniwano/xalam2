package com.esmt.xalam2.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.esmt.xalam2.service.EmailAlreadyUsedException ||
            ex instanceof com.esmt.xalam2.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.esmt.xalam2.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.esmt.xalam2");
    }
}
